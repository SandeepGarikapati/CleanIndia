            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-green-500">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-black-400 uppercase tracking-wider">Rank</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-black-400 uppercase tracking-wider">User</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-black-400 uppercase tracking-wider">Points</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-black-400 uppercase tracking-wider">Level</th>
                  </tr>
                </thead>
                <tbody>
