    ...
    <div className="container mx-auto px-4 py-16">
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          Nirmal-Bhumi <span className="text-green-600">Waste Management</span>
        </h1>
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <ImpactCard title="Waste Collected" value={`100 kg`} icon={Recycle} />
          <ImpactCard title="Reports Submitted" value={`200`} icon={MapPin} />
          <ImpactCard title="Tokens Earned" value={`10`} icon={Coins} />
          <ImpactCard title="CO2 Offset" value={`40 kg`} icon={Leaf} />
        </div>
      </section>
